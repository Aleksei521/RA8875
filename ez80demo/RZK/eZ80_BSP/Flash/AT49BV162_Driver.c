...
#endif
{
   UINT8              * addr = (UINT8 *)((UINT)paddr & AT49BV162_MASK_BITS);
...
INT AT49BV162_Write( UINT8 * paddr, UINT8 * pbuf, UINT num_bytes )
#ifdef _IAR_CODE
@ "DATA_PER_RAM"
#endif
{
   UINT8              * base_addr = (UINT8 *)((UINT)paddr & AT49BV162_MASK_BITS);
   UINT8                result;
   UINT                 nbytes = 0;
   UINTRMASK            IntMask;
...
INT AT49BV162_Erase( UINT8 * paddr, UINT num_bytes )
#ifdef _IAR_CODE
@ "DATA_PER_RAM"
#endif
{
