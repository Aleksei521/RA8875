...
extern RZK_DEVICE_CB_t 		PppDevice;
...
struct commonServers csTbl={
 	"172.16.6.48",		/* Default Timer Server */
...
/*interface 1 -> PPP Configuration*/
{
	&PppDevice,			/* Control block for this device*/
	PPP,				/* interface type */
	1500,				/* MTU */
	PPP_56K,			/* Speed */ /* may have values such as PPP_115K, PPP_56K, PPP_9K */
	"192.168.1.91",		/* Default IP address */
	"192.168.1.92",		/* Default Gateway */
	0xffffff00UL		/* Default Subnet Mask */ 
}
};
...
INT16 		g_sock_inactive			= 	300; //Timeout in seconds a tcp socket if not active for more than specified time(default 5 min), set 0 to disable 
...
UINT8      	g_console_dev_to_use	= 	DEV_SERIAL1 ;
...
/*FTP port variables*/
UINT16 g_FTPCmdPort = FTP_CONTROL_PORT; //server
UINT16 g_FTPDataPort = FTP_DATA_PORT;
