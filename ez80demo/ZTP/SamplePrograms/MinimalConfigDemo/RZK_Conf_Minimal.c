...
#define MAX_MESSAGEQSH                  (10)
#define MAX_EVENTGROUPSH                (3)
...
#define MAX_PARTITIONSH                 (4)
#define MAX_REGIONSH                    (2)
#define MAX_REGIONS_TABH                (50)
