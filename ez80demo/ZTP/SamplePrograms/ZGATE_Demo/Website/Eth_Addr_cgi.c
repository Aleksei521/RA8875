/************************************************************************************************
** File:        Eth_Addr_cgi.c
** Description: Dynamically generates ZGATE Ethernet source MAC Address configuration page.
**
...
INT16
ZGATE_Eth_AddrList_cgi
(
   struct http_request * pReq
)
{
   return( ZGATE_GenCgiResponse(pReq, ZGATE_ETH_ADDR_LIST) );
}
