/************************************************************************************************
** File:        Eth_Type_cgi.c
** Description: Dynamically generates ZGATE Ethernet Frame Type configuration page.
**
...
INT16
ZGATE_Eth_TypeList_cgi
(
   struct http_request * pReq
)
{
   return( ZGATE_GenCgiResponse(pReq, ZGATE_ETH_FRAME_LIST) );
}
