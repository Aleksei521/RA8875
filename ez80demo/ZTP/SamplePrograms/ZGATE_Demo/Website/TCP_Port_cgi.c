/************************************************************************************************
** File:        TCP_Port_cgi.c
** Description: Dynamically generates ZGATE TCP destination Port number configuration page.
**
...
INT16
ZGATE_TCP_PortList_cgi
(
   struct http_request * pReq
)
{
   return( ZGATE_GenCgiResponse(pReq, ZGATE_TCP_PORT_LIST) );
}
