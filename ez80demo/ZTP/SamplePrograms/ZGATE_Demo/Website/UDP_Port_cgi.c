/************************************************************************************************
** File:        UDP_Port_cgi.c
** Description: Dynamically generates ZGATE UDP destination Port number configuration page.
**
...
INT16
ZGATE_UDP_PortList_cgi
(
   struct http_request * pReq
)
{
   return( ZGATE_GenCgiResponse(pReq, ZGATE_UDP_PORT_LIST) );
}
